...
#define IN_USERP_MODE(STATUS) ((STATUS & USERPON) == USERPON)
#define IN_KERNELP_MODE(STATUS) (!IN_USER_MODE())
#define FULL_TIME_SLICE (unsigned int) 5000
#define PSEUDO_CLOCK_TICKS 100000
